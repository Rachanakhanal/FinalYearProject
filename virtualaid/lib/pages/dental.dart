    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 17.8, middle: 0.2257),
            Pin(size: 16.5, end: 36.6),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 15.6, middle: 0.471),
            Pin(size: 17.5, end: 33.7),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 21.5, middle: 0.7238),
            Pin(size: 19.4, end: 33.7),
            child:
          ...
          // ignore: prefer_const_constructors
          Align(
            alignment: const Alignment(0.025, -0.081),
            // ignore: prefer_const_constructors
            child: SizedBox(
              width: 157.0,
              height: 22.0,
          ...
          // ignore: prefer_const_constructors
          Align(
            alignment: const Alignment(0.11, 0.271),
            // ignore: prefer_const_constructors
            child: SizedBox(
              width: 205.0,
              height: 22.0,
...
const String _svg_ooqxx =
    '<svg viewBox="162.2 708.8 15.6 17.5" ><path transform="translate(158.2, 704.84)" d="M 11.79905891418457 12.75 C 13.95354652404785 12.75 15.69858551025391 10.79218673706055 15.69858551025391 8.374998092651367 C 15.69858551025391 5.957812309265137 13.95354652404785 4 11.79905891418457 4 C 9.644567489624023 4 7.899529933929443 5.957812309265137 7.899529933929443 8.374998092651367 C 7.899529933929443 10.79218673706055 9.644567489624023 12.75 11.79905891418457 12.75 Z M 11.79905891418457 14.93749904632568 C 9.196123123168945 14.93749904632568 4 16.40312576293945 4 19.3125 L 4 21.5 L 19.59811592102051 21.5 L 19.59811592102051 19.3125 C 19.59811592102051 16.40312576293945 14.40199279785156 14.93749904632568 11.79905891418457 14.93749904632568 Z" fill="#000000" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
