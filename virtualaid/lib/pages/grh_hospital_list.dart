...
import 'grh_derma.dart';
import 'heh_eye.dart';
// ignore: depend_on_referenced_packages
import 'package:flutter_svg/flutter_svg.dart';

class GRHHospitalList extends StatelessWidget {
  const GRHHospitalList({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          // ignore: prefer_const_constructors
          Align(
            alignment: const Alignment(0.0, -0.091),
            // ignore: prefer_const_constructors
            child: SizedBox(
              width: 154.0,
              height: 32.0,
          ...
          // ignore: prefer_const_constructors
          Align(
            alignment: const Alignment(0.005, 0.277),
            // ignore: prefer_const_constructors
            child: SizedBox(
              width: 175.0,
              height: 32.0,
          ...
          Pinned.fromPins(
            Pin(size: 18.8, middle: 0.2086),
            Pin(size: 17.6, end: 41.0),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 15.6, middle: 0.5064),
            Pin(size: 17.5, end: 43.5),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 21.5, middle: 0.757),
            Pin(size: 19.4, end: 44.0),
            child:
...
const String _svg_v0y82 =
    '<svg viewBox="100.0 92.0 244.0 1.0" ><path transform="translate(100.0, 92.0)" d="M 0 0 L 115.3281173706055 0 L 170.2916870117188 0 L 243.9999847412109 0" fill="none" stroke="#100f0f" stroke-width="4" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_f5nhe4 =
    '<svg viewBox="174.4 699.0 15.6 17.5" ><path transform="translate(170.4, 695.0)" d="M 11.79905891418457 12.75 C 13.95354652404785 12.75 15.69858551025391 10.79218673706055 15.69858551025391 8.374998092651367 C 15.69858551025391 5.957812309265137 13.95354652404785 4 11.79905891418457 4 C 9.644567489624023 4 7.899529933929443 5.957812309265137 7.899529933929443 8.374998092651367 C 7.899529933929443 10.79218673706055 9.644567489624023 12.75 11.79905891418457 12.75 Z M 11.79905891418457 14.93749904632568 C 9.196123123168945 14.93749904632568 4 16.40312576293945 4 19.3125 L 4 21.5 L 19.59811592102051 21.5 L 19.59811592102051 19.3125 C 19.59811592102051 16.40312576293945 14.40199279785156 14.93749904632568 11.79905891418457 14.93749904632568 Z" fill="#000000" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
